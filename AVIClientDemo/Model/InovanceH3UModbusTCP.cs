...
namespace AVIClientDemo.Model
{
    public class InovanceH3UModbusTCP : IPLCCommunication
    {
        public bool ConnectState { get; set; }
        private DXH.Modbus.DXHModbusTCP ModbusTCP_Client;
        public InovanceH3UModbusTCP(string ip)
        {
